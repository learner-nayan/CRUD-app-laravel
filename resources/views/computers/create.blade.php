...
<div class="container">
  ...
  <form class="form-horizontal" action="{{route('computers.store')}}" method="post">
    @csrf
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="number" step="0.01" class="form-control" id="storage" placeholder="Enter storage" name="storage">
      </div>
    </div>
    <div class="form-group">
